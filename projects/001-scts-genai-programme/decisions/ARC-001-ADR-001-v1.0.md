...
| 1.1 | 2026-01-29 | ArcKit AI | Updated with Azure Research findings (ARC-001-AZRS-v1.0): revised cost estimates, added service pricing table | [PENDING] | [PENDING] |
...
- **Azure Research**: [ARC-001-AZRS-v1.0](../research/ARC-001-AZRS-v1.0.md) - Azure Technology Research with service recommendations and pricing
- **Research findings**: `projects/001-scts-genai-programme/research/ARC-001-RSCH-001-v1.0.md` - Section "Build vs Buy Summary"
- **Related ADRs**: N/A (this is the foundational platform decision)
- **Stakeholder drivers**: `projects/001-scts-genai-programme/ARC-001-STKE-v1.0.md`
...
- ✅ **Lowest 3-Year TCO**: ~£286,000 for all AI services based on Azure Research (ARC-001-AZRS-v1.0)
...
|---------|---------|------|--------------|
| Azure AI Document Intelligence | Document classification & entity extraction | S0 | £2,363 |
| Azure AI Speech | Real-time transcription & speaker diarisation | S0 | £1,020 |
...
| **Total AI Services** | | | **£4,337/month** |

#### Cost Analysis (Updated from Azure Research)
| Cost Item | Year 1 | Year 2 | Year 3 | Notes |
|-----------|--------|--------|--------|-------|
| AI Services (monthly) | £52,044 | £50,484 | £48,996 | With reserved instance savings |
| Supporting Infrastructure | £16,380 | £16,380 | £16,380 | API Management, Functions, Storage, SQL |
| Integration Development | £40,000 | £10,000 | £10,000 | Initial + maintenance |
| Training/Adoption | £15,000 | £5,000 | £5,000 | Staff training |
| **Total** | **£123,424** | **£81,864** | **£80,376** | |
| **3-Year TCO** | | | **£285,664** | All four AI capabilities |

*Note: Cost estimates revised based on Azure Research (ARC-001-AZRS-v1.0) using current Azure pricing. Previous estimates were based on preliminary analysis.*
...
1. **Lowest 3-Year TCO**: Based on Azure Research (ARC-001-AZRS-v1.0), Azure AI Services has a 3-year TCO of approximately £286,000 for AI services, significantly less than Google Cloud or custom build options, and delivers substantial value vs doing nothing.
...
- Azure AI services analysis (Document Intelligence, Speech, Translator, Search)
- Architecture pattern and implementation guidance
- Security and compliance mapping

**Research findings**: `projects/001-scts-genai-programme/research/ARC-001-RSCH-001-v1.0.md`
...
- [ARC-001-AZRS-v1.0](../research/ARC-001-AZRS-v1.0.md) - Azure Technology Research with detailed service analysis
...
**Build vs Buy Detailed Comparison** (Updated with Azure Research ARC-001-AZRS-v1.0):

| Factor | Azure AI | Google Cloud | Custom Build | Weight |
|--------|----------|--------------|--------------|--------|
| 3-Year TCO | £286K | £785K | £990K | 25% |
| Time to Value | 6 months | 8 months | 18 months | 20% |
| UK Data Residency | ✅ UK South/West | ✅ London | ✅ Azure UK | 15% |
| G-Cloud Approved | ✅ G-Cloud 14 (RM1557.14) | ✅ Yes | N/A | 10% |
...
**Azure AI Services Monthly Costs** (from ARC-001-AZRS-v1.0):

| Service | Monthly Cost | Annual Cost |
|---------|--------------|-------------|
| Document Intelligence (S0) | £2,363 | £28,356 |
| Speech Services (S0) | £1,020 | £12,240 |
| Translator (S1) | £484 | £5,808 |
| AI Search (S1 + replica) | £470 | £5,640 |
| Supporting Infrastructure | £1,365 | £16,380 |
| **Total** | **£5,702** | **£68,424** |
