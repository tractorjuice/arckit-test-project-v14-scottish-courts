...
| Field | Value |
|-------|-------|
| **Document ID** | ARC-001-SECRISK-v1.1 |
...
| **Reviewed By** | PENDING |
| **Approved By** | PENDING |
| **Distribution** | SIRO, CISO, CDiO, Architecture Board, Security Team |
...
|---------|------|--------|---------|-------------|---------------|
| 1.1 | 2026-01-27 | ArcKit AI | Updated to template v0.11.2 format; added Document Control fields, Glossary | PENDING | PENDING |
| 1.0 | 2026-01-20 | ArcKit AI | Initial creation from `/arckit.risk` command (security focus) | PENDING | PENDING |
...
| Term | Definition |
|------|------------|
| **CAF** | Cyber Assessment Framework - NCSC's systematic approach to cyber risk assessment |
...
| **Orange Book** | HM Treasury's guidance on risk management |
