...
|---------|------|--------|---------|
| 1.0 | 2026-01-17 | ArcKit AI | Initial creation from `/arckit.risk` command |
...
**Framework**: HM Treasury Orange Book (2023)
**Source Artifacts**: Stakeholder Drivers, DPIA, Secure by Design Assessment, Requirements, Architecture Principles
